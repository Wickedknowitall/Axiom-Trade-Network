            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                <p className="text-xl text-muted-foreground mb-12 leading-relaxed">
                  Complete the form below to register your interest in our upcoming events. We'll send you detailed information and registration links.
                </p>
...
export default EventInterestPage;
